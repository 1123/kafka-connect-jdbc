...
public class JdbcSourceConnectorConfig extends AbstractConfig {
  ...
  public static final String TABLE_TO_INCREMENT_COLUMN_NAME_MAPPING_CONFIG =
          "table.to.incrementing.column.name.mapping";
  public static final String TABLE_TO_INCREMENT_COLUMN_NAME_MAPPING_DOC =
          "A mapping from table to names to the names of the columns that hold the "
                  + "incrementing ids. This is required, since the column names that hold "
                  + "the incrementing ids may be different for the tables. "
  ...
  private static final void addModeOptions(ConfigDef config) {
    ...
    config.define(
        ...
        QUERY_RETRIES_DISPLAY
            ...
            TABLE_TO_INCREMENT_COLUMN_NAME_MAPPING_CONFIG,
            Type.LIST,
            "",
            Importance.HIGH,
            TABLE_TO_INCREMENT_COLUMN_NAME_MAPPING_DOC
    );
  }
